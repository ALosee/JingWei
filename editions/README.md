...
| 文件             | ID            | 用途                   | 当前根模块                                          |
| ---------------- | ------------- | ---------------------- | --------------------------------------------------- |
| `development.ts` | `development` | 本地开发和默认质量验证 | iam、branding、organization、navigation、dictionary |
| `full.ts`        | `full`        | 当前完整产品组合       | iam、branding、organization、navigation、dictionary |
