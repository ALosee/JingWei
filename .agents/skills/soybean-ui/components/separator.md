...
For layout-level spacing between sections, prefer the [`SCard`](https://ui.soybeanjs.cn/components/card.md) or UnoCSS spacing utilities; use `SSeparator` when a visible dividing line aids comprehension.
