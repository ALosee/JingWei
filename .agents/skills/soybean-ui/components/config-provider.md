...
You can fully customize the theme using the `theme` prop. more details can be found in the [theming documentation](https://ui.soybeanjs.cn/overview/theming.md).
...
<template>
  <SConfigProvider locale="en" :messages="messages"></SConfigProvider>
</template>
```
