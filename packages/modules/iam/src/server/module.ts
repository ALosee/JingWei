...
export interface IamServerModuleDependencies {
  readonly organizationalScopeFacts?: OrganizationalScopeFacts
}

export function createIamServerModule(
  dependencies: IamServerModuleDependencies = {},
): ServerModule {
  return {
    manifest,
    async install(context) {
      ...
      const manageRoles = new ManageIamRoles(
        ...
        dependencies.organizationalScopeFacts ?? null,
      )
...
export const serverModule = createIamServerModule()
