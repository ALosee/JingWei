...
export const switchVariants = scv({
  slots: {
    root: 'inline-flex',
    control: [
  ...
  variants: {
    ...
    size: {
      xs: {
        control: 'h-4 w-7',
        thumb:
          'size-3 data-[state=checked]:translate-x-3.5 rtl:data-[state=checked]:-translate-x-3.5',
      },
      sm: {
        control: 'h-4.5 w-8',
        thumb:
          'size-3.5 data-[state=checked]:translate-x-4 rtl:data-[state=checked]:-translate-x-4',
      },
      md: {
        control: 'h-5 w-9',
        thumb:
          'size-4 data-[state=checked]:translate-x-4.5 rtl:data-[state=checked]:-translate-x-4.5',
      },
      lg: {
        control: 'h-5.5 w-10',
        thumb:
          'size-4.5 data-[state=checked]:translate-x-5 rtl:data-[state=checked]:-translate-x-5',
      },
      xl: {
        control: 'h-6 w-11',
        thumb:
          'size-5 data-[state=checked]:translate-x-5.5 rtl:data-[state=checked]:-translate-x-5.5',
      },
      '2xl': {
        control: 'h-7 w-13',
        thumb:
          'size-6 data-[state=checked]:translate-x-6.5 rtl:data-[state=checked]:-translate-x-6.5',
      },
    },
    shape: {
      rounded: {
